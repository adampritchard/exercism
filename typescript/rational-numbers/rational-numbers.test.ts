import { Rational, greatestCommonDenominator } from './rational-numbers'

describe('greatestCommonDenominator', () => {
  it('1/1 = 1', () => {
    expect(greatestCommonDenominator(1, 1)).toEqual(1)
  })

  it('1/2 = 1', () => {
    expect(greatestCommonDenominator(1, 2)).toEqual(1)
  })

  it('2/4 = 2', () => {
    expect(greatestCommonDenominator(2, 4)).toEqual(2)
  })

  it('2/6 = 2', () => {
    expect(greatestCommonDenominator(2, 6)).toEqual(2)
  })

  it('20/60 = 20', () => {
    expect(greatestCommonDenominator(20, 60)).toEqual(20)
  })

  it('4/6 = 2', () => {
    expect(greatestCommonDenominator(4, 6)).toEqual(2)
  })
})
